...
namespace LongoMatch.Core.Common
{
	public class StyleConf
	{
		...
		public const string ListEyeIconPath = "icons/hicolor/scalable/actions/longomatch-eye.svg";
		public const string ListArrowRightPath = "icons/hicolor/scalable/actions/longomatch-arrow-right.svg";
		public const string ListArrowDownPath = "icons/hicolor/scalable/actions/longomatch-arrow-down.svg";

		public const int TeamsShieldIconSize = 45;
		
		public const string TimelineNeedleResource = "icons/hicolor/scalable/actions/longomatch-timeline-needle-big.svg";
		public const string TimelineNeedleUP = "icons/hicolor/scalable/actions/longomatch-timeline-needle-up.svg";
		...
		public const string TimelineSelectionLeft = "icons/hicolor/scalable/actions/longomatch-timeline-select-left.svg";
		public const string TimelineSelectionRight = "icons/hicolor/scalable/actions/longomatch-timeline-select-right.svg";

		public const string PlayerArrowOut = "images/player/arrow-out.svg";
		public const string PlayerArrowIn = "images/player/arrow-in.svg";
		public const string PlayerPhoto = "images/player/photo.svg";
		...
		public const string SubsLock = "icons/hicolor/scalable/actions/longomatch-player-swap-lock.svg";
		public const string SubsUnlock = "icons/hicolor/scalable/actions/longomatch-player-swap-unlock.svg";
		public const string SubsIcon = "icons/hicolor/scalable/actions/longomatch-subs-arrow.svg";
		public const string DefaultShield = "icons/hicolor/scalable/actions/longomatch-default-shield.svg";

		public const string EditButton = "icons/hicolor/scalable/actions/longomatch-pencil.svg";
		public const string ApplyButton = "icons/hicolor/scalable/actions/longomatch-apply-button.svg";
		public const string CancelButton = "icons/hicolor/scalable/actions/longomatch-mark.svg";
		public const string RecordButton = "icons/hicolor/scalable/actions/longomatch-control-record.svg";
		...
		public const string ButtonTimerIcon = "images/dashboard/longomatch-timer.svg";
		public const string ButtonTagIcon = "images/dashboard/longomatch-tag.svg";
		public const string ButtonScoreIcon = "images/dashboard/longomatch-score.svg";
		public const string ButtonEventIcon = "images/dashboard/longomatch-event.svg";
		...
		public const string LinkIn = "icons/hicolor/scalable/actions/longomatch-link-in.svg";
		public const string LinkInPrelight = "icons/hicolor/scalable/actions/longomatch-link-in-prelight.svg";
		public const string LinkOut = "icons/hicolor/scalable/actions/longomatch-link-out.svg";
		public const string LinkOutPrelight = "icons/hicolor/scalable/actions/longomatch-link-out-prelight.svg";
