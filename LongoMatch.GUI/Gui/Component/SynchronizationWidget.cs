	...
	public partial class SynchronizationWidget : Gtk.Bin, IView<CameraSynchronizationVM>
	{
		...
		public CameraSynchronizationVM ViewModel {
			...
			set {
				if (videoPlayerVM != null) {
					videoPlayerVM.PropertyChanged -= HandlePropertyChanged;
				}
				camSyncVM = value;
				if (camSyncVM != null) {
					...
					camerasTimeline.ViewModel = projectVM;
		...
		void HandlePropertyChanged (object sender, PropertyChangedEventArgs e)
		{
			if (e.PropertyName == nameof (videoPlayerVM.CurrentTime)) {
				timerule.CurrentTime = videoPlayerVM.CurrentTime;
				camerasTimeline.CurrentTime = videoPlayerVM.CurrentTime;
			}
		}
	}
}
