	...
	public partial class VideoFileInfo : Gtk.Bin
	{
		...
		void UpdateMediaFile ()
		{
			...
			if (mediaFile.IsFakeCapture) {
				...
				snapshotimage.Image = App.Current.ResourcesLocator.LoadIcon ("longomatch-video-device-fake", PREVIEW_SIZE);
			...
			if (mediaFile.Preview != null) {
				...
				snapshotimage.Image = App.Current.ResourcesLocator.LoadIcon ("longomatch-video-file", PREVIEW_SIZE);
			}
