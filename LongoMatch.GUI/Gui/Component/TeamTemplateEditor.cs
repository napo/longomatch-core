...
namespace LongoMatch.Gui.Component
{
	...
	public partial class TeamTemplateEditor : Gtk.Bin, IView<LMTeamEditorVM>
	{
		...
		public TeamTemplateEditor ()
		{
			...
			applyimage.Image = App.Current.ResourcesLocator.LoadIcon ("longomatch-apply", StyleConf.ButtonDialogIconSize);

			teamtagger = new LMTeamTaggerView (new WidgetWrapper (drawingarea));
			shieldvbox.WidthRequest = SHIELD_SIZE;
			shieldimage.SetSize (SHIELD_SIZE, SHIELD_SIZE);
		...
		public LMTeam Team {
			set {
				...
				if (template.Shield != null) {
					...
					shieldimage.Image = App.Current.ResourcesLocator.LoadIcon ("longomatch-default-shield", SHIELD_SIZE);
				}
		...
		void ClearPlayer ()
		{
			...
			mailentry.Text = "";
			playerimage.Image = App.Current.ResourcesLocator.LoadIcon ("longomatch-player-pic", PLAYER_SIZE);
		...
		Image PlayerPhoto (LMPlayer p)
		{
			...
			if (p.Photo != null) {
				...
				playerImage = App.Current.ResourcesLocator.LoadIcon ("longomatch-player-pic", PLAYER_SIZE);
			}
			return playerImage;
		}
