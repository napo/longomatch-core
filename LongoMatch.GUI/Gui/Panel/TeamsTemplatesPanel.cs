...
namespace LongoMatch.Gui.Panel
{
	...
	public partial class TeamsTemplatesPanel : Gtk.Bin, IPanel<TeamsManagerVM>
	{
		...
		public TeamsTemplatesPanel ()
		{
			...
			teamimage.Image = App.Current.ResourcesLocator.LoadIcon ("longomatch-team-header", StyleConf.TemplatesHeaderIconSize);
			playerheaderimage.Image = App.Current.ResourcesLocator.LoadIcon ("longomatch-player-header", StyleConf.TemplatesHeaderIconSize);
